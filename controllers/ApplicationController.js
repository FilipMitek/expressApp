...
var appMailer = require("../mailer/appMailer");
exports.validate = [
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new application_1.Application(application).save()];
                case 1:
                    _a.sent();
                    console.log("Insert to database " + req.body.name);
                    return [4 /*yield*/, appMailer.applicationNotify({
                ...
                case 3:
                    err_1 = _a.sent();
                    return [2 /*return*/, ErrorHandler_1.catchError(err_1, req, res)];
                case 4:
