...
var sgConfig = require("../config/sendgrid");
var pug = require("pug");
var path = require("path");
exports.send = function (options) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, sgMail.send(sgConfig.message)];
